...
public class PreviousMessages extends Message {
    ...
    public static final String TYPE_GET_PREVIOUS_CHAT_MESSAGES = "type_get_previous_chat_messages";
    ...
    public Collection<ChatMessage> getChatMessages() { return chatMessages; }
